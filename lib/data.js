import {
  ...
  ShoppingBag, Church, Gem, Heart, PartyPopper, Stethoscope, Film, Building2,
} from "lucide-react";
...
export async function fetchAllData() {
  ...
  const CATEGORIES = [
    ...
    { id: "event-halls", name: "Event Halls & Venues", count: String(eventHalls.length) + "+", icon: Building2, color: "#5D4037", data: eventHalls, subs: ["Banquet Hall", "Community Center", "Hotel Ballroom", "Outdoor Venue", "Temple Hall", "Restaurant Venue", "Convention Center"], desc: "Banquet halls and venues for weddings, receptions, and community events." },
