...
export async function fetchAllData() {
  ...
  const CATEGORIES = [
    ...
    { id: "professionals", name: "Professionals", count: String(professionals.length) + "+", icon: UserCheck, color: "#37474F", data: null, subs: [], desc: "Doctors, attorneys, CPAs, realtors, and financial advisors." },
  ];
