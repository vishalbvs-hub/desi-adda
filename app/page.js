...
const QUICK_CATS = [
  ...
  { emoji: "\u{1F490}", label: "Weddings", href: "/event-planning" },
  ...
  { emoji: "\u{1F3E0}", label: "Roommates", href: "/classifieds?cat=roommates" },
  { emoji: "\u{1F4BC}", label: "Jobs", href: "/classifieds?cat=jobs" },
  { emoji: "\u{1F37D}\uFE0F", label: "Catering", href: "/event-planning" },
  { emoji: "\u{1F4B8}", label: "Money Transfer", href: "/businesses?cat=travel" },
  { emoji: "\u{1F697}", label: "Auto", href: "/classifieds?cat=for-sale" },
