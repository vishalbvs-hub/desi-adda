...
export default function MoviesPage() {
  ...
  if (loading) return (<div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#FFFBF5" }}><div style={{ textAlign: "center" }}><div style={{ fontSize: "48px", marginBottom: "12px" }}>{"\u{1F3AC}"}</div><p style={{ fontFamily: ff, fontSize: "18px", color: COLORS.textMuted }}>Loading movies...</p></div></div>);
  ...
  return (
    <div style={{ borderRadius: "16px", overflow: "hidden", background: "white", border: "1px solid #EDE6DE", transition: "all 0.25s", display: "flex", flexDirection: "column" }} onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = "0 12px 32px rgba(0,0,0,0.1)"; }} onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}>
      ...
      <div style={{ padding: "16px", flex: 1, display: "flex", flexDirection: "column" }}>
        <h3 style={{ fontFamily: ff, fontSize: "17px", fontWeight: 700, margin: "0 0 8px", color: "#2D2420", lineHeight: 1.3 }}>{movie.title}</h3>
        ...
        <div style={{ display: "flex", gap: "8px", marginTop: "auto" }}>
          ...
          {movie.trailer_youtube_id && (<button onClick={() => onTrailer(movie.trailer_youtube_id)} style={{ flex: 1, padding: "10px 14px", borderRadius: "10px", background: "#2D2420", color: "white", fontSize: "12px", fontWeight: 700, fontFamily: fb, border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "6px" }}><Play size={13} /> Trailer</button>)}
        </div>
      </div>
    </div>
  );
