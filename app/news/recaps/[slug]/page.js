      ...
      <div style={{ background: "#F5F2EB", minHeight: "100vh" }}>
        ...
        <article style={{ maxWidth: "720px", margin: "0 auto", padding: "40px 20px 60px" }}>
          <div style={{ marginBottom: "24px" }}>
            <div style={{ display: "flex", gap: "8px", alignItems: "center", fontSize: "13px", color: "#6B6B6B", marginBottom: "12px" }}>
            ...
            <h1 style={{ fontFamily: ff, fontSize: "clamp(28px, 5vw, 40px)", fontWeight: 700, margin: "0 0 8px", color: "#1A1A1A", lineHeight: 1.2 }}>{recap.title}</h1>
            {recap.location && <div style={{ fontSize: "14px", color: "#6B6B6B", display: "flex", alignItems: "center", gap: "4px" }}>📍 {recap.location}</div>}
          </div>

          <div style={{ borderTop: "1px solid #E2DFD8", paddingTop: "24px" }}>
            <div style={{ fontFamily: fb, fontSize: "16px", color: "#1A1A1A", lineHeight: 1.7, whiteSpace: "pre-line" }}>{recap.body_text}</div>
          </div>
          ...
          <div style={{ marginTop: "40px", textAlign: "center", padding: "28px", background: "white", borderRadius: "10px", border: "1px dashed #E2DFD8" }}>
            <p style={{ fontFamily: ff, fontSize: "18px", fontWeight: 600, margin: "0 0 8px", color: "#1A1A1A" }}>Were you there?</p>
            <p style={{ fontSize: "14px", color: "#6B6B6B", margin: "0 0 16px" }}>Share your photos and we&apos;ll add them to this recap.</p>
