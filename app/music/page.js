...
const APPLE_ICON = (
  <svg width="16" height="16" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
    <rect width="56" height="56" rx="12" fill="url(#apple_grad)"/>
    <defs><linearGradient id="apple_grad" x1="28" y1="0" x2="28" y2="56" gradientUnits="userSpaceOnUse"><stop stopColor="#FA233B"/><stop offset="1" stopColor="#FB5C74"/></linearGradient></defs>
    <path d="M36.5 8.5C36.5 8.5 36.5 17 36.5 22.5C36.5 23.5 36.5 25.5 36.5 27C36.5 31.5 33.5 34.5 29 34.5C25.5 34.5 23 32 23 29C23 25.5 25.5 23.5 29.5 23.5C31 23.5 32 23.8 33 24.3L33 14.5L22.5 17L22.5 32C22.5 32 22.5 34 22.5 35.5C22.5 39.5 19.5 42.5 15.5 42.5C12 42.5 9.5 40 9.5 37C9.5 33.5 12 31.5 16 31.5C17.2 31.5 18.2 31.8 19 32.2L19 13L36.5 8.5Z" fill="white"/>
  </svg>
);
